...
<body>
				...
				<div class="col-md-12">
					<div class="card">
						<div class="card-body">
							...
							<form name="OrderForm" id="OrderForm" class="form"
								action="Payment?a=pay" method="post">
								...
								<div class="form-group row">
									...
									<div class="col-sm-3">
										<input type="password" name="otp" class="form-control"
											id="otp" placeholder="OTP" required="required">
									</div>
									<span class="text-primary">Please check your registered
										email to get the OTP.<br>Expired in <span
										class="countdown"></span> minutes.
									</span>
								</div>
								<div class="form-group row">
					...
					<div class="col-md-12 m-3 text-right">
						<a href="TopUp" class="btn btn-info btn-md">Cancel</a>
					</div>
	...
	<script>
		...
		// redirect to google after 5 minutes
		window.setTimeout(function() {
		    window.location.href = '/MERCHANT2U/TopUp';
		}, 300000);
